...
@Parcelize
data class AsteroidModel(val element_count: Int?, val links: Links?, val near_earth_objects: NearEarthObjects?) : Parcelable {

    @Parcelize
    data class Links(val next: String?, val previous: String?, val self: String?) : Parcelable
